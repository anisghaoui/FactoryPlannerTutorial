...
![in game](../figures/figure/in_game.png?raw=true)

You are faced with the main interface as shown in the figure below.

![in game interface](../figures/figure/main_interface.png?raw=true)
...
![gears](../figures/figure_interface/gears.png?raw=true)
...
![selected gears recipe](../figures/figure_interface/gears_selected.png?raw=true)
...
![gears recipe](../figures/figure_interface/gears_recipe.png?raw=true)
...
![modified gears](../figures/figure_interface/gears_modified.png?raw=true)
...
![unrolled recipe](../figures/figure_interface/recipe_unroll.png?raw=true)
...
![red science](../figures/basic_recipe/red_science.png?raw=true)

Warning: "*OH NO, I got this huge error! what do I do?*"
Answer: "*simply press cancel, then ctrl click the last row's recipe*"
![red science](../figures/basic_recipe/dependence.png?raw=true)
...
![lubricant](../figures/matrix_solver/lubricant.png?raw=true)
